...
{
    public class ExclusiveOrFormulaRef : ExclusiveOrFormula, IExclusiveOrFormulaRef
    {
        protected internal ExclusiveOrFormulaRef()
            : this(default(IFormulaRef), default(IFormulaRef), default(ITypeDeclaration), default(IMethodDeclaration), default(IFormulaRef))
        {
        }

        protected internal ExclusiveOrFormulaRef(IFormulaRef left, IFormulaRef right, ITypeDeclaration type, IMethodDeclaration method, IFormulaRef parent)
        ...
        public IExclusiveOrFormula Establish()
        {
            var established = default(IExclusiveOrFormula);
            FirstHierarchyOnly(() =>
            {
                ...
                established = Formula.ExclusiveOr(left, right, type, method, parent);
            });
            return established;
        }
