...
{
    public class NotEqualFormulaRef : NotEqualFormula, INotEqualFormulaRef
    {
        protected internal NotEqualFormulaRef()
            : this(default(IFormulaRef), default(IFormulaRef), default(ITypeDeclaration), default(IMethodDeclaration), default(IFormulaRef))
        {
        }

        protected internal NotEqualFormulaRef(IFormulaRef left, IFormulaRef right, ITypeDeclaration type, IMethodDeclaration method, IFormulaRef parent)
        ...
        public INotEqualFormula Establish()
        {
            var established = default(INotEqualFormula);
            FirstHierarchyOnly(() =>
            {
                ...
                established = Formula.NotEqual(left, right, type, method, parent);
            });
            return established;
        }
