...
{
    public class AssignFormulaRef : AssignFormula, IAssignFormulaRef
    {
        protected internal AssignFormulaRef()
            : this(default(IFormulaRef), default(IFormulaRef), default(ITypeDeclaration), default(IMethodDeclaration), default(IFormulaRef))
        {
        }

        protected internal AssignFormulaRef(IFormulaRef left, IFormulaRef right, ITypeDeclaration type, IMethodDeclaration method, IFormulaRef parent)
        ...
        public IAssignFormula Establish()
        {
            var established = default(IAssignFormula);
            FirstHierarchyOnly(() =>
            {
                ...
                established = Formula.Assign(left, right, type, method, parent);
            });
            return established;
        }
